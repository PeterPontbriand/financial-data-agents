...
FCF_03: Final = Case(
    ...
    expectation=Expectation(tool_constraints=_FCF_TOOL_CONSTRAINTS),
    tags=("as_of", "fcf_earnings_growth", "input_unavailable", "non_contiguous_history"),
)


FCF_EARNINGS_GROWTH_CASES: Final[tuple[Case, ...]] = (FCF_01, FCF_02, FCF_03)

__all__ = ["FCF_01", "FCF_02", "FCF_03", "FCF_EARNINGS_GROWTH_CASES"]
