...
Defines five deterministic screening strategies, data boundaries and verification requirements.
...
| :--- | :--- | :--- |
| 3.5.1 | Shared data mappings and applicability helpers | Planned |
| 3.5.2 | Piotroski → Altman → Beneish → multiples → Magic Formula | Planned |
...
- Golden-Suite extension so that the new strategies participate in the deterministic benchmark with the existing strategies.
