...
**Status:** Gate A and Slices B1–B6, C1, C2, C3, D1, D2, D3, D4 and D5 accepted; D5 accepted on 2026-09-18 (America/Toronto). D5 completes the D-series (Momentum, Number, Growth, and FCF adapters plus the save service). E1 is the next slice and has not been started.
