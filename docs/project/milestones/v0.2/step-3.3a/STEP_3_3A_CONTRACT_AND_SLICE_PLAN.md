...
**Branch:** Renamed locally to `codex/step-3.3a-database-readiness` on 2026-09-09 for this planning/implementation work. The starting local branch was `feat/step-3.4-research-workspace`, at `b6a84e0`, with two documentation commits after Step 3.3 and no configured upstream. Renaming preserves those commits and working-tree content. No commit, push, or PR is authorized by this plan.
