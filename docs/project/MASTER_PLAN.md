...
**Selected sequence:** R1 → Step 3.2 scope reconciliation/completion → Step 3.3 → P2-Profiles → Step 3.4 → Step 3.5. Each implementation unit requires its own authorization. P2-ETF remains deferred beyond 3.5 until separately prioritized.
