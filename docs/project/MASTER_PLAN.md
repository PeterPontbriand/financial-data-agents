...
* **R1: Analyzer Separation & CLI Support:** Complete the reviewed method-specific analyzer/config and CLI migration work before Step 3.4 by explicit sequencing choice, not a technical dependency. The R1-A contract record was approved on 2026-09-06; implementation remains unstarted pending the requested documentation checkpoint commit. Approval authorizes R1-B only; further slices retain separate gates.
